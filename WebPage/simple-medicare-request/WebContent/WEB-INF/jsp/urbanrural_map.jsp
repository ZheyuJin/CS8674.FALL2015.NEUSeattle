...
<div>
<ul>
<li>Darker areas indicate higher density of providers in that county - aka: urban</li>
<li>Lighter areas indicate a lower density of providers</li>
<li>White areas indicate a county with no provider data.</li>
</ul>
</div>
<div class="map"></div>
<h6></h6>
