...
public class SolrTestController 
{
  ...
  // Redirect to the page for entering query parameters and submitting the query
  ...
  // Get the provider results for the given state and procedure code and return them in a results page.
  ...
  public String getProviderPage(
                                @RequestParam(value="state", required=true) String state,  // Abbreviated state value
                                @RequestParam(value="proc", required=true) String proc_code,  // hcpcs code
                                Model model)
  {
     ...
     * http://localhost:8080/simple-medicare-request/hunter/main/solr/provider?state=AZ&proc=92213
     * @throws Exception 
     */
  @RequestMapping(value = "/provider", method = RequestMethod.GET)
  public @ResponseBody List<Provider> getTop(
        @RequestParam(value="state", required=true) String state,  // Abbreviated state value
        @RequestParam(value="proc", required=true) String proc_code,  // hcpcs code
