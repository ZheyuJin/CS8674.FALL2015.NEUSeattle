...
//		}
	...
	System.out.println("avg medicare payment :" + test.providerDetails.averageMedicarePaymentAmount);
	System.out.println("avg medicare allowed :" + test.providerDetails.averageMedicareAllowedAmount);
	System.out.println("hcpcs_drug_indicator is: " + test.providerDetails.hcpcs_drug_indicator);
	System.out.println("avg submitted charge is " + test.providerDetails.averageSubmittedChargeAmount);
